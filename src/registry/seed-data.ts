...
export const SEED_PRODUCTS: SeedProduct[] = [
  ...
  // ─── HOSTING ───────────────────────────────────────────────────────────
  {
    product: {
      ...
      category: 'hosting',
      description:
        'Frontend cloud platform for deploying web applications. First-class Next.js support, edge functions, image optimization, and analytics. Generous hobby tier.',
      pricing: 'Hobby free; Pro $20/user/mo; Enterprise custom',
      features: ['Edge network', 'Serverless functions', 'Image optimization', 'Preview deployments', 'Analytics', 'Web Application Firewall', 'Cron jobs'],
      integrations: ['Next.js', 'React', 'Svelte', 'Nuxt', 'Astro', 'Remix', 'GitHub', 'GitLab', 'Bitbucket'],
      bestFor: ['Next.js apps', 'frontend teams', 'preview deployments', 'static sites', 'JAMstack'],
    ...
    programs: [
      {
        ...
        affiliateLink: 'https://vercel.com/partners',
        payoutType: 'hybrid',
        payoutAmount: 5,
        payoutCurrency: 'USD',
        cookieDays: 30,
  ...
  },
  {
    product: {
      ...
      category: 'hosting',
      description:
        'Cloud infrastructure provider offering droplets (VMs), managed Kubernetes, databases, app platform, and object storage. Simple pricing and developer-friendly docs.',
      pricing: 'Droplets from $4/mo; App Platform free tier; Managed DB from $15/mo',
      features: ['Droplets (VMs)', 'Kubernetes', 'App Platform', 'Managed databases', 'Spaces (object storage)', 'Load balancers', 'VPC', 'Monitoring'],
      integrations: ['Docker', 'Kubernetes', 'Terraform', 'Ansible', 'GitHub Actions', 'GitLab CI', 'Node.js', 'Python', 'Go'],
      bestFor: ['small-medium infrastructure', 'developers wanting simple cloud', 'managed Kubernetes', 'predictable pricing'],
    ...
    programs: [
      {
        ...
        affiliateLink: 'https://www.digitalocean.com/?refcode=placeholder',
  ...
  },
  {
    product: {
      ...
      category: 'email',
      description:
        'All-in-one marketing platform for email campaigns, automations, landing pages, and audience management. One of the most well-known email marketing tools.',
      pricing: 'Free up to 500 contacts; Essentials from $13/mo; Standard from $20/mo; Premium from $350/mo',
      features: ['Email campaigns', 'Marketing automations', 'Landing pages', 'Audience segmentation', 'A/B testing', 'Social posting', 'Reporting'],
      integrations: ['Shopify', 'WordPress', 'WooCommerce', 'Squarespace', 'Zapier', 'Salesforce', 'Canva'],
      bestFor: ['small business email marketing', 'newsletter beginners', 'e-commerce integration', 'all-in-one marketing'],
    ...
    programs: [
      {
        network: 'direct',
        affiliateLink: 'https://mailchimp.com/referral/',
        payoutType: 'per-sale',
        payoutAmount: 25,
        payoutCurrency: 'USD',
        cookieDays: 30,
  ...
  },
  {
    product: {
      ...
      category: 'email',
      description:
        'Email marketing platform designed for creators. Offers visual automations, landing pages, commerce features, and subscriber tagging. Rebranded from Kit.',
      pricing: 'Free up to 10K subscribers (limited); Creator from $25/mo; Creator Pro from $50/mo',
      features: ['Visual automation builder', 'Landing pages', 'Commerce (digital products)', 'Subscriber tagging', 'A/B testing', 'RSS campaigns', 'Creator Network'],
      integrations: ['WordPress', 'Shopify', 'Teachable', 'Zapier', 'Patreon', 'Squarespace', 'Gumroad'],
      bestFor: ['content creators', 'bloggers', 'newsletter operators', 'digital product sellers', 'course creators'],
  ...
  // ─── ADDITIONAL TOOLS ──────────────────────────────────────────────────
  {
    product: {
      ...
      category: 'seo',
      description:
        'All-in-one SEO and digital marketing toolkit. Keyword research, site audit, rank tracking, backlink analysis, and competitive intelligence.',
      pricing: 'Pro $129.95/mo; Guru $249.95/mo; Business $499.95/mo',
      features: ['Keyword research', 'Site audit', 'Rank tracking', 'Backlink analysis', 'Competitive analysis', 'Content marketing', 'Social media', 'PPC research'],
      integrations: ['Google Analytics', 'Google Search Console', 'WordPress', 'Looker Studio', 'Zapier', 'Trello'],
      bestFor: ['SEO professionals', 'content marketers', 'competitive analysis', 'agency teams'],
    ...
    programs: [
      {
        network: 'Impact',
        affiliateLink: 'https://www.semrush.com/partner/',
        payoutType: 'per-sale',
        payoutAmount: 200,
        payoutCurrency: 'USD',
        cookieDays: 120,
